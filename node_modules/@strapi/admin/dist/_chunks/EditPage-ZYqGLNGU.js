...
const useWebhooks = require("./useWebhooks-g-u-eEUU.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-mrhO0K1Q.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-ZYqGLNGU.js.map
