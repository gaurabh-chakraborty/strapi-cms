...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-Sz0bqxDe.mjs";
...
import { u as useWebhooks } from "./useWebhooks-6gjatBnz.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable--um8UljY.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-bquHSnU-.mjs.map
