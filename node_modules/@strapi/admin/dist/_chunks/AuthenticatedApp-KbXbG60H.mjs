...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-Sz0bqxDe.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.14.1",
  "@strapi/permissions": "4.20.0",
  "@strapi/provider-audit-logs-local": "4.20.0",
  "@strapi/types": "4.20.0",
...
const devDependencies = {
  ...
  "@strapi/data-transfer": "4.20.0",
  "@strapi/pack-up": "4.20.0",
  "@strapi/plugin-content-manager": "4.20.0",
...
const CM = React.lazy(
  () => import("./index-Sz0bqxDe.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-rVmtVStB.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage--dfQ96ij.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-0PF5qCum.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-Sz0bqxDe.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-lLKkzUCW.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-vOgSvtVD.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-KbXbG60H.mjs.map
