...
const ListView$1 = lazy(() => import("./ListView-8xgfY7z-.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-8xgfY7z-.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-5XW4A5fl.mjs.map
